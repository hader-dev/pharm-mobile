...
import 'package:hader_pharm_mobile/features/common/filters/medicine/cubit/medicines_filters_cubit.dart';
...
class FilterPriceSectionState extends State<FilterPriceSection> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MedicinesFiltersCubit, MedicinesFiltersState>(
      builder: (context, state) {
        final MedicinesFiltersCubit cubit = context.read<MedicinesFiltersCubit>();
        return InfoWidget(
      ...
      children: [
        ...
        CustomTextField(
          ...
          onChanged: (value) {
            if (tag == 'min') {
              context
                  .read<MedicinesFiltersCubit>()
                  .changeFilters(context.read<MedicinesFiltersCubit>().tempFilters.copyWith(
