...
import '../cubit/para_pharm_filters_cubit.dart'
    show
        ...
        ParaPharmFiltersCategorySearchLoaded,
        ParaPharmFiltersCategorySearchLoading,
        ParaPharmFiltersCategorySearchLoadingFailed;
...
class _CategorySearchFilterState extends State<CategorySearchFilter> {
  ...
  Widget build(BuildContext context) {
    return InfoWidget(
      label: "${context.translation!.category}: ",
      ...
      value: OverlayPortal(
                ...
                Container(
                    ...
                    child: BlocBuilder<ParaPharmFiltersCubit, ParaPharmFiltersState>(
                      builder: (context, state) {
                        if (state is ParaPharmFiltersCategorySearchLoading) {
                          return const Center(
        ...
        child: CompositedTransformTarget(
          ...
          child: CustomTextField(
            controller: context.read<ParaPharmFiltersCubit>().categorySearchController,
            suffixIcon: context.watch<ParaPharmFiltersCubit>().categorySearchController.text.isEmpty
                ? null
                : InkWell(
                    onTap: () {
            ...
            onChanged: (value) {
              ...
              context.read<ParaPharmFiltersCubit>().searchCategories(searchValue: value!.isEmpty ? null : value);
            },
          ),
        ),
      ),
