    ...
    <BottomNavigationBarItem>[
      BottomNavigationBarItem(
        icon: Padding(
          ...
          child: generateBottomSvgIcon(
              context,
              DrawableAssetStrings.newHomeIcon,
              context.read<AppLayoutCubit>().pageIndex == 0),
        ),
      ...
      BottomNavigationBarItem(
        icon: Padding(
          ...
          child: generateBottomSvgIcon(
              context,
              DrawableAssetStrings.newMarketIcon,
              context.read<AppLayoutCubit>().pageIndex == 1),
        ),
        ...
        icon: Padding(
          ...
          child: BlocBuilder<CartCubit, CartState>(
            builder: (context, state) {
              return AppLayout.appLayoutScaffoldKey.currentContext!
                      .read<CartCubit>()
                      .state
                      .cartItems
                      .isEmpty
                  ? generateBottomSvgIcon(
                      context,
                      DrawableAssetStrings.newEmptyCartIcon,
      ...
      BottomNavigationBarItem(
        icon: Padding(
          ...
          child: generateBottomSvgIcon(
              context,
              DrawableAssetStrings.newOrderBoxIcon,
              context.read<AppLayoutCubit>().pageIndex == 3),
        ),
      ...
      BottomNavigationBarItem(
        icon: Padding(
          ...
          child: generateBottomSvgIcon(
              context,
              DrawableAssetStrings.newProfileIcon,
              context.read<AppLayoutCubit>().pageIndex == 4),
        ),
        label: translation.profile,
      ),
    ];

SvgPicture generateBottomSvgIcon(
        BuildContext context, String svgPath, bool isSelected) =>
    SvgPicture.asset(
      svgPath,
