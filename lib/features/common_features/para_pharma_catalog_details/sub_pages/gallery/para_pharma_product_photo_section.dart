...
import 'package:hader_pharm_mobile/features/common_features/para_pharma_catalog_details/sub_pages/gallery/widget/interactive_image_view.dart'
    show ProductInteractivePictures;
...
import 'cubit/gallery_cubit.dart' show GalleryCubit, GalleryState, SelectedGalleryChanged;
...
class ParaPharmaProductPhotoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<GalleryItem> galleryItems = [
      GalleryItem(imgPath: cubit.state.paraPharmaCatalogData.image?.path ?? ""),
      ...cubit.state.paraPharmaCatalogData.gallery!.items
    ];
    ...
    return BlocProvider(
        ...
        child: Stack(
          ...
          children: [
            ...
            if (cubit.state.paraPharmaCatalogData.gallery!.items.isNotEmpty)
