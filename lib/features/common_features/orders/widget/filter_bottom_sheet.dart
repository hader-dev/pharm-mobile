...
import 'package:hader_pharm_mobile/models/order_filters.dart' show OrderFiltersKeys;
                ...
                children: [
                  ...
                  CustomTextField(
                    ...
                    suffixIcon: state.filters.createdAtTo.isNotEmpty
                        ? InkWell(
                            onTap: () {
                              cubit.updatedFilters(state.filters.updateFilterList(OrderFiltersKeys.createdAtTo, []));
                            },
                            child: Icon(
                              Icons.close,
                              size: context.responsiveAppSizeTheme.current.p16,
