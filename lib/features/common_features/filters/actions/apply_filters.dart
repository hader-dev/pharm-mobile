...
void applyFiltersOrder(BuildContext context) {
  final appliedFilters =
      context.read<OrdersFiltersCubit>().state.appliedFilters;
  final targetDataCubit = context.read<OrdersCubit>();
  targetDataCubit.updatedFilters(appliedFilters);
  targetDataCubit.getOrders(filters: appliedFilters);
}
