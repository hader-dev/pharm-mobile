    ...
    return Column(
      children: [
        InkAccordion(
          ...
          children: [
            InkAccordionItem(
                rawTitle: translation.filter_items_status, onTap: () {}),
            InkAccordionItem(
                rawTitle: translation.filter_items_register_date, onTap: () {}),
            InkAccordionItem(
                rawTitle: translation.filter_items_country, onTap: () {}),
                InkAccordionItem(
                rawTitle: translation.filter_items_patent, onTap: () {})
          ],
        ),
      ],
    );
