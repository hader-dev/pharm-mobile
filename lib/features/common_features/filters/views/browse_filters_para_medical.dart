            ...
            Column(
              children: [
                InkAccordionItem(
                  ...
                  onTap: () => navigateToParaFiltersApplyView(context, ParaMedicalFiltersKeys.name),
                  rawSubtitle: getDisplayedParaFiltersAsRawString(context, ParaMedicalFiltersKeys.name),
                ),
                InkAccordionItem(
                  rawTitle: context.translation!.filter_items_description,
                  onTap: () => navigateToParaFiltersApplyView(context, ParaMedicalFiltersKeys.description),
                  rawSubtitle: getDisplayedParaFiltersAsRawString(context, ParaMedicalFiltersKeys.description),
                ),
                InkAccordionItem(
