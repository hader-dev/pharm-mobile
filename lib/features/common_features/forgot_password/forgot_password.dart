...
import 'package:hader_pharm_mobile/features/common_features/forgot_password/widgets/reset_password_link_sent_bottom_sheet.dart';
      ...
      child: BlocBuilder<ForgotPasswordCubit, ForgotPaswordState>(
        builder: (context, state) {
          if (state is ResetLinkSent) {
            return const PasswordResetLinkSentScreen();
          }
