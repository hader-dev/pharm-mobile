...
class SelectPaymentMethodBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      value: DeligateMarketPlaceScreen.marketPlaceScaffoldKey.currentContext!
          .read<DeligateCreateOrderCubit>(),
      child: BlocListener<DeligateCreateOrderCubit, DeligateCreateOrderState>(
        listener: (context, state) {
          if (state is PassOrderLoaded) {
            context
                .read<DeligateCreateOrderCubit>()
                .clearItems(context.translation!);
        ...
        child: BlocBuilder<DeligateCreateOrderCubit, DeligateCreateOrderState>(
          builder: (context, state) {
            ...
            return Form(
              key: context.read<DeligateCreateOrderCubit>().formKey,
                          ...
                          Expanded(
                            ...
                            child: PrimaryTextButton(
                              ...
                              onTap: () {
                                context
                                    .read<DeligateCreateOrderCubit>()
                                    .submitOrderWithClient(
                                        DeligateMarketPlaceScreen
                                            .marketPlaceScaffoldKey
                                            .currentContext!
