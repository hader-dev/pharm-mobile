...
class OrderCard extends StatelessWidget {
  ...
  OrderCard({super.key, required this.orderData, this.displayClientCompanyOrVendor = false}) {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        GoRouter.of(context).pushNamed(RoutingManager.deligateOrderDetailsScreen, extra: orderData.id);
      },
      child: Container(
        ...
        child: Column(
          ...
          children: [
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            ...
                            style: context.responsiveTextTheme.current.headLine4SemiBold.copyWith(color: Colors.black)),
                        TextSpan(
                          text: "\n (${orderData.createdAt.formatYMD})",
            ...
            InfoRow(
              ...
              dataValue:
                  (displayClientCompanyOrVendor ? orderData.clientCompanyName : orderData.sellerCompanyName) ?? "N/A",
