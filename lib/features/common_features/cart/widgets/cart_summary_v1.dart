                    ...
                    BlocBuilder<CartCubit, CartState>(
                      builder: (context, state) {
                        return FormattedPrice(
                          ...
                          valueStyle: context.responsiveTextTheme.current.bodySmall.copyWith(
                    ...
                    BlocBuilder<CartCubit, CartState>(
                      builder: (context, state) {
                        return FormattedPrice(
                          ...
                          valueStyle: context.responsiveTextTheme.current.body2Medium.copyWith(
                            fontWeight: context.responsiveTextTheme.current.appFont.appFontBold,
                            color: Colors.black,
                          ),
                          unitStyle: context.responsiveTextTheme.current.bodyXSmall.copyWith(
              ...
              BlocBuilder<CartCubit, CartState>(builder: (context, state) {
                return PrimaryTextButton(
                  ...
                  onTap: state.cartItems.isEmpty
                      ? null
                      : () {
                          BottomSheetHelper.showCommonBottomSheet(context: context, child: CheckOutBottomSheet());
                        },
