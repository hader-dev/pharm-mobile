...
class DelegateOrderSummarySection extends StatelessWidget {
  const DelegateOrderSummarySection({super.key});

  @override
  Widget build(BuildContext context) {
    DelegateOrderDetails2Cubit cubit = context.read<DelegateOrderDetails2Cubit>();
    return Container(
        ...
        children: <Widget>[
          ...
          SummaryRow(
            ...
            value: PaymentMethods.values
                .firstWhere(
                    (element) => element.id == context.read<DelegateOrderDetails2Cubit>().state.orderData.paymentMethod,
          ...
          SummaryRow(
              ...
              value: (cubit.state.orderData.totalAppliedAmountTtc).formatAsPriceForPrint()),
          // SummaryRow(
