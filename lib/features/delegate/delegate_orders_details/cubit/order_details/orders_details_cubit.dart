...
import 'package:hader_pharm_mobile/config/language_config/resources/app_localizations.dart' show AppLocalizations;
...
import 'package:hader_pharm_mobile/models/deligate_order.dart' show DeligateOrderItemUi, DeligateOrderItem;
import 'package:hader_pharm_mobile/models/order_change.dart' show OrderChangeModel;

import 'package:hader_pharm_mobile/models/order_details.dart';
import 'package:hader_pharm_mobile/models/para_pharma.dart' show BaseParaPharmaCatalogModel;
...
import '../../../../../repositories/remote/order/params/update_order.dart' show ParamsUpdateOrder;
import '../../../../../utils/bottom_sheet_helper.dart' show BottomSheetHelper;
import '../../../../../utils/toast_helper.dart' show ToastManager, ToastType;

import '../../widgets/track_order_bottom_sheet.dart' show OrderTrackingBottomSheet;

part 'orders_details_state.dart';

class DelegateOrderDetails2Cubit extends Cubit<DelegateOrdersDetails2State> {
  final IOrderRepository orderRepository;
  DebounceManager debounceManager = DebounceManager();
  OrderChangeModel orderChangeModel = OrderChangeModel();

  DelegateOrderDetails2Cubit({
    ...
    switch (option) {
      case 'orderTracking':
        BottomSheetHelper.showCommonBottomSheet(
            context: DelegateOrdersDetailsScreen.delegateOrdersDetailsScaffoldKey.currentContext!,
