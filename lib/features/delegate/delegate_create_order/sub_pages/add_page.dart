...
import 'package:hader_pharm_mobile/features/delegate/delegate_create_order/widgets/client_selector.dart';
import 'package:hader_pharm_mobile/features/delegate/delegate_create_order/widgets/product_selector.dart';
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          OrderClientSelector(
            onChanged: (value) => value != null ? cubit.updateClient(value) : null,
