...
import 'package:hader_pharm_mobile/features/delegate/deligate_marketplace/cubit/marketplace_cubit.dart';
...
class SelectPaymentMethodBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      value: DeligateMarketPlaceScreen.marketPlaceScaffoldKey.currentContext!.read<DelegateCreateOrderCubit>(),
      child: BlocListener<DelegateCreateOrderCubit, DelegateCreateOrderState>(
        listener: (context, state) {
          if (state is PassOrderLoaded) {
            context.read<DelegateCreateOrderCubit>().clearItems(context.translation!);
        ...
        child: BlocBuilder<DelegateCreateOrderCubit, DelegateCreateOrderState>(
          builder: (context, state) {
            ...
            return Form(
              key: context.read<DelegateCreateOrderCubit>().formKey,
                  ...
                  children: [
                    ...
                    InfoWidget(
                        ...
                        value: PaymentRadioInput(
                          ...
                          onPaymentMethodChanged: context.read<DelegateCreateOrderCubit>().updatePaymentMethod,
                    ...
                    InfoWidget(
                        ...
                        value: InvoiceRadioInput(
                          validator: (v) => requiredValidator(v?.name, translation),
                          onInvoiceTypeChanged: context.read<DelegateCreateOrderCubit>().updateInvoiceType,
                    ...
                    InfoWidget(
                        ...
                        value: CustomTextField(
                          ...
                          onChanged: (text) =>
                              context.read<DelegateCreateOrderCubit>().updateShippingAddress(text ?? ''),
                          maxLines: 3,
                    ...
                    InfoWidget(
                        ...
                        value: CustomTextField(
                          ...
                          onChanged: (text) => context.read<DelegateCreateOrderCubit>().changeOrderNote(text ?? ''),
                          maxLines: 3,
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: PrimaryTextButton(
                              ...
                              onTap: () {
                                context.read<DelegateCreateOrderCubit>().submitOrderWithClient(DeligateMarketPlaceScreen
                                    .marketPlaceScaffoldKey.currentContext!
                                    .read<DeligateMarketplaceCubit>()
                                    .state
                                    .client);
                              },
                              color: AppColors.accent1Shade1,
