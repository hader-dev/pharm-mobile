...
class LoginCubit extends Cubit<LoginState> {
  ...
  TextEditingController userNameController = TextEditingController(text: "ayoub@mail.com");
  TextEditingController passwordController = TextEditingController(text: "Hader@12");
