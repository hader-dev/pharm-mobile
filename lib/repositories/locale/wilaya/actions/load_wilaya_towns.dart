...
Future<ResponseLoadWilayaTowns> loadWilayaTowns(ParamsLoadWilayaTowns params) async {
  try {
    final jsonLoader = params.jsonStringLoader ?? rootBundle.loadString;
    final String path = '${params.rootPath}/town_${params.wilayaId}_${params.locale}.json';
