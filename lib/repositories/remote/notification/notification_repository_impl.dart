...
class NotificationRepository extends INotificationRepository {
  ...
  Future<NotificationModel> getNotificationById(int id) async {
    var data = jsonDecode(await DataLoaderHelper.loadDummyData(JsonAssetStrings.notificationsJson));
  ...
  Future<List<NotificationModel>> getNotifications() async {
    var data = jsonDecode(await DataLoaderHelper.loadDummyData(JsonAssetStrings.notificationsJson));
    return (data as List).map((prod) => NotificationModel.fromJson(prod)).toList();
  }
}
