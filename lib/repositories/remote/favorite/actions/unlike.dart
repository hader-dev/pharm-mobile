...
Future<void> unLikeParaPharmaCatalog({required String paraPharmaCatalogId, required INetworkService client}) async {
  await client.sendRequest(() => client.delete(
        "${Urls.favoritesUnLikeParaPharmaCatalog}/$paraPharmaCatalogId",
      ));
}

Future<void> unLikeMedicineCatalog({required String medicineCatalogId, required INetworkService client}) async {
  await client.sendRequest(() => client.delete(
