...
OrderItem jsonToOrderItem(Map<String, dynamic> json) {
  return OrderItem(
      ...
      totalAppliedAmountHt: json['totalAppliedAmountHt'] != null ? double.parse(json['totalAppliedAmountHt']) : null,
      totalAppliedAmountTtc: json['totalAppliedAmountTtc'] != null ? double.parse(json['totalAppliedAmountTtc']) : null,
      unitPriceApplied: json['appliedAmount'] != null ? double.parse(json['appliedAmount']) : null,
      customPriceHt: json['customPriceHt'] != null ? double.parse(json['customPriceHt']) : 0.0,
      ...
      discountAmountHt: json['discountAmountHt'] != null ? double.parse(json['discountAmountHt']) : 0.0,
      orderId: json['orderId'],
      appliedAmountHt: json['appliedAmountHt'] != null ? double.parse(json['appliedAmountHt']) : 0.0,
      appliedAmountTtc: json['appliedAmountTtc'] != null ? double.parse(json['appliedAmountTtc']) : 0.0);
}
